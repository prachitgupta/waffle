...
class OUTPUT():
	...
	def Move(self, linear_x, angular_theta):
		...
		self.pub_vel.publish(self.vel) #actual vel given to waffle
...
class INPUT(threading.Thread):
	...
	def __init__(self, scan='/scan', odom='/odom', imu='/imu', camera='/camera/rgb/image_raw', cameraRGB='/camera/rgb/image_raw'):
